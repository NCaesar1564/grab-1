...
const information = ({ name, vote, price, quality, note, Inc, Dec }: any) => {
    return (
        <div className='flex flex-col items-start justify-center gap-y-3'>
            ...
            <div>{note}</div>
            <div className='flex'>
                <button onClick={Dec} className={`px-3 border cursor-pointer ${quality  <= 1 ? 'text-gray-500 border-gray-200' : ''}`}>-</button>
                <p className='border border-gray-200 px-5 py-1'>{quality}</p>
